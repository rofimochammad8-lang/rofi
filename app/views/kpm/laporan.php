<?php
// ============================================
// FILE: app/views/kpm/laporan.php
// Fungsi: Halaman lihat laporan untuk KPM
// ============================================
...
<div class="main-content">
    ...
    <div class="topbar">
        <h5><i class="bi bi-file-earmark-text me-2"></i>Lihat Laporan</h5>
        <span class="date"><i class="bi bi-calendar3 me-1"></i><?= date('d F Y') ?></span>
    </div>

    <div class="content-area">
        <div class="card-table">
            <h6><i class="bi bi-journal-text me-2"></i>Daftar Laporan Stunting</h6>
            <hr>
...
<div class="modal fade" id="modalLaporan" tabindex="-1">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content" style="border-radius:12px;">
            ...
            <div class="modal-body" style="font-size:14px;line-height:1.8;" id="modalIsi"></div>
...
document.getElementById('modalLaporan').addEventListener('show.bs.modal', function (e) {
    ...
    document.getElementById('modalIsi').textContent   = btn.getAttribute('data-isi');
});
</script>
